...
export const getDefaultIngestConfig = (): IngestConfig => ({
  ...
  yavendras: {
    ...
    sources: [
      ...
      { slug: "matrimonios", page: 1 },
      { slug: "suegras", page: 1 },
      { slug: "ninos", page: 1 },
      { slug: "animales", page: 1 },
      { slug: "escuela", page: 1 },
    ],
  },
  todochistes: {
    ...
    sources: [
      ...
      { categorySlug: "matrimonios", perPage: 10 },
      { categorySlug: "suegras", perPage: 10 },
      { categorySlug: "abogados", perPage: 10 },
      { categorySlug: "animales", perPage: 10 },
      { categorySlug: "parejas", perPage: 10 },
      { categorySlug: "maestros", perPage: 10 },
      { categorySlug: "locos", perPage: 10 },
      { categorySlug: "policias", perPage: 10 },
    ],
  },
});
