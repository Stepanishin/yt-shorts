...
export interface NewsAutoGenerationJob {
  ...
  // Generation data
  newsId: string; // ID from news_candidates_pt collection
...
const CONFIG_COLLECTION = "auto_generation_configs_news_pt";
const QUEUE_COLLECTION = "auto_generation_queue_news_pt";
