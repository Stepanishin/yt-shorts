...
export interface NewsAutoGenerationJob {
  ...
  // Generation data
  newsId: string; // ID from news_candidates_en collection
...
const CONFIG_COLLECTION = "auto_generation_configs_news_en";
const QUEUE_COLLECTION = "auto_generation_queue_news_en";
