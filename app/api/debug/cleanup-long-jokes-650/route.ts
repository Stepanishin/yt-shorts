...
/**
 * POST /api/debug/cleanup-long-jokes-650
 * Помечает все pending анекдоты длиннее 650 символов как deleted
 */
export async function POST() {
  try {
    ...
    console.log(`Found ${longJokes.length} pending jokes longer than 650 characters`);
