...
/**
 * POST /api/debug-fr/cleanup-long-jokes-600
 * Помечает все pending французские анекдоты длиннее 600 символов как deleted
 */
export async function POST() {
  try {
    ...
    console.log(`[FR] Found ${longJokes.length} pending jokes longer than 600 characters`);
