...
import { getNewsJobsByUser } from "@/lib/db/auto-generation-news";

/**
 * GET /api/auto-generation-news/queue
 * Get news auto-generation jobs for the user
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Error fetching news jobs:", error);
    return NextResponse.json(
