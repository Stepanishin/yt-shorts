...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Error fetching English news auto-generation config:", error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("Error saving English news auto-generation config:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error("Error deleting English news auto-generation config:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
