...
/**
 * GET /api/auto-generation-news-pt/config
 * Get current Portuguese news auto-generation configuration for the user
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Error fetching Portuguese news auto-generation config:", error);
    return NextResponse.json(
...
/**
 * POST /api/auto-generation-news-pt/config
 * Create or update Portuguese news auto-generation configuration
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("Error saving Portuguese news auto-generation config:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
...
/**
 * DELETE /api/auto-generation-news-pt/config
 * Delete Portuguese news auto-generation configuration
 */
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error("Error deleting Portuguese news auto-generation config:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
