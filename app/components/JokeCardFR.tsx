...
export default function JokeCardFR({ joke }: JokeCardFRProps) {
  const sourceLabels: Record<string, string> = {
    "blague-drole": "BLAGUE-DROLE.NET",
    "blagues-en-stock": "BLAGUES-EN-STOCK.ORG",
    "blague-humour": "BLAGUE-HUMOUR.COM",
  };
  ...
  return (
    <Link href={`/dashboard/jokes-fr/${joke._id}`}>
