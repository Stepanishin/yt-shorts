...
export default function AutoGenerationFRPage() {
  ...
  const loadConfig = async () => {
    try {
      const response = await fetch("/api/auto-generation-fr/config");
  ...
  const handleTest = async () => {
    ...
    try {
      const response = await fetch("/api/auto-generation-fr/generate-now", {
        method: "POST",
      });
